...
list_folder = dir('output/results/20230403/', pattern = 'n_unique_total')
list_folder

n_unique_total = lapply(1:length(list_folder), function(x){
  get(load(paste('output/results/20230403/', list_folder[x], sep = '')))
})

list_folder = dir('output/results/20230403/', pattern = 'nb_unique_total')
list_folder

nb_unique_total = lapply(1:length(list_folder), function(x){
  get(load(paste('output/results/20230403/', list_folder[x], sep = '')))
})
